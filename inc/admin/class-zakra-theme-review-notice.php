...
class Zakra_Theme_Review_Notice {
	...
	public function __construct() {
		...
		add_action( 'admin_enqueue_scripts', array( $this, 'zakra_theme_review_notice_enqueue' ) );
	...
	public function zakra_theme_rating_notice() {
		...
		$option = get_option( 'zakra_theme_installed_time' );
	...
	public function zakra_theme_review_notice() {
		...
		<div class="notice updated theme-review-notice" style="position:relative;">
			...
			<a class="notice-dismiss" style="text-decoration:none;"
			   href="?nag_zakra_ignore_theme_review_notice=0"></a>
		</div>
	...
	public function zakra_ignore_theme_review_notice() {
		...
		if ( isset( $_GET['nag_zakra_ignore_theme_review_notice'] ) && '0' == $_GET['nag_zakra_ignore_theme_review_notice']
			...
			add_user_meta( $user_id, 'zakra_ignore_theme_review_notice', 'true', true );
		}
	...
	public function zakra_ignore_theme_review_notice_partially() {
		...
		if ( isset( $_GET['nag_zakra_ignore_theme_review_notice_partially'] ) && '0' == $_GET['nag_zakra_ignore_theme_review_notice_partially'] ) {
			update_user_meta( $user_id, 'nag_zakra_ignore_theme_review_notice_partially', time() );
		}
	 ...
	 */
	public function zakra_theme_review_notice_enqueue() {

		wp_enqueue_style( 'zakra-theme-review-notice', ZAKRA_PARENT_INC_URI . '/admin/css/theme-review-notice.css' );
