					...
					<div class="options-group">
						...
						<div class="zakra-ui-field">
							<label class="tg-label">
								<input type="radio" name="zakra_layout" value="tg-site-layout--customizer" <?php
								checked( $layout, 'tg-site-layout--customizer' ); ?> />
								<img src="<?php echo esc_url( ZAKRA_PARENT_URI . '/assets/img/icons/customizer.png' ); ?>" />
							</label>
							<label class="tg-label">
								<input type="radio" name="zakra_layout" value="tg-site-layout--default" <?php checked
								( $layout, 'tg-site-layout--default' ); ?> />
								<img src="<?php echo esc_url( ZAKRA_PARENT_URI . '/assets/img/icons/layout-default.png' ); ?>" />
							</label>
							<label class="tg-label">
								<input type="radio" name="zakra_layout" value="tg-site-layout--left" <?php checked(
										$layout, 'tg-site-layout--left' ); ?> />
								<img src="<?php echo esc_url( ZAKRA_PARENT_URI . '/assets/img/icons/left-sidebar.png' ); ?>" />
							</label>
							<label class="tg-label">
								<input type="radio" name="zakra_layout" value="tg-site-layout--right" <?php checked(
										$layout, 'tg-site-layout--right' ); ?> />
								<img src="<?php echo esc_url( ZAKRA_PARENT_URI . '/assets/img/icons/right-sidebar.png' ); ?>" />
							</label>
							<label class="tg-label">
								<input type="radio" name="zakra_layout" value="tg-site-layout--no-sidebar" <?php
								checked( $layout, 'tg-site-layout--no-sidebar' ); ?> />
								<img src="<?php echo esc_url( ZAKRA_PARENT_URI . '/assets/img/icons/full-width.png' ); ?>" />
							</label>
							<label class="tg-label">
								<input type="radio" name="zakra_layout" value="tg-site-layout--stretched" <?php
								checked( $layout, 'tg-site-layout--stretched' ); ?> />
					...
					<div class="options-group">
						...
						<div class="zakra-ui-field">
							<input type="checkbox"
									...
									value="1" <?php checked( $remove_content_margin, 1 ); ?>>
						</div>
					</div>
					...
					<div class="options-group">
						...
						<div class="zakra-ui-field">
							<select name="zakra_sidebar" id="zakra-sidebar">
								<option value="default" <?php selected( $sidebar, 'default' ); ?>><?php esc_html_e( 'Default', 'zakra' ); ?></option>
								<option value="sidebar-right" <?php selected( $sidebar, 'sidebar-right' ); ?>><?php
									esc_html_e( 'Sidebar Right', 'zakra' ); ?></option>
								<option value="sidebar-left" <?php selected( $sidebar, 'sidebar-left' ); ?>><?php
									esc_html_e( 'Sidebar Left', 'zakra' ); ?></option>
								<option value="footer-sidebar-1" <?php selected( $sidebar, 'footer-sidebar-1' );
								?>><?php esc_html_e( 'Footer One', 'zakra' ); ?></option>
								<option value="footer-sidebar-2" <?php selected( $sidebar, 'footer-sidebar-2' );
								?>><?php esc_html_e( 'Footer Two', 'zakra' ); ?></option>
								<option value="footer-sidebar-3" <?php selected( $sidebar, 'footer-sidebar-3' );
								?>><?php esc_html_e( 'Footer Three', 'zakra' ); ?></option>
								<option value="footer-sidebar-4" <?php selected( $sidebar, 'footer-sidebar-4' );
								?>><?php esc_html_e( 'Footer Four', 'zakra' ); ?></option>
							</select>
						</div>
					</div>
